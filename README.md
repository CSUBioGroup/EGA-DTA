...
* `drug_graph_construct.py`: Generates molecular graphs with BDE/BL attributes (requires `alfabet` for BDE prediction：https://github.com/ NREL/alfabet ).
...
Since the ALFABET model is based on TensorFlow, we have placed all preprocessed data (smile_graph.pkl, esm2_features_<datasetname>.pkl, <datsetname_task>.pt) and trained model weights at the following link: https://drive.google.com/drive/folders/1eQPO3dr4NfqUja_oW_bSAq6DUVAIyGWl?usp=drive_link
